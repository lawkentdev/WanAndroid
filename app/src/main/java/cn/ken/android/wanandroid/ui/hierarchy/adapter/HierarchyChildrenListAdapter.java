...
public class HierarchyChildrenListAdapter extends RecyclerView.Adapter<HierarchyChildrenListAdapter.ViewHolder> {
...
//            }
    ...
    public HierarchyChildrenListAdapter(List<FeedArticleData> feedArticleList) {
